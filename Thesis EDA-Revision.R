...
event_plot <- ggplot(df_long, aes(x = Date, y = Index)) +
  ...
  labs(
    title = "Economic Indicators Over Time with Global Volatility Events Highlighted",
    x = "Date",
    y = "Index",
    fill = "Event"
  ) +
...
ggsave(
  "time_series_event_plot_no_stand.png",
  plot = event_plot,
  width = 10,
  height = 8,
  dpi = 600,
...
event_plot_diff <- ggplot(df_long_diff, aes(x = Date, y = Index)) +
  ...
  labs(
    title = "Differenced Economic Indicators Over Time with Global Volatility Events Highlighted",
    x = "Date",
    y = "Index",
    fill = "Event"
  ) +
...
ggsave(
  "diff_time_series_event_plot_new.png",
  plot = event_plot_diff,
  width = 10,
  height = 8,
  dpi = 600,
  limitsize = FALSE
